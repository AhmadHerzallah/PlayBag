  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TouchableOpacity onPress={() => Linking.openURL(item.video)}>
        <Image
          style={[styles.imagestyle, { width: width, height: height / 3 }]}
      ...
      >
        ...
        >
          <Ionicons name={'person'} size={15} color={'white'} /> {item.views}
        </Text>
        <Text
          style={[
            styles.views,
      ...
      <Text
        style={[
          ...
          {
            color: linkcolor,
            marginBottom: height / 10 + 8,
            fontSize: width / 14.5 - 10,
          },
        ]}
        onPress={() => {
          changelinkcolor('#b3b3b3')
